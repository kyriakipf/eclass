...
@section('content')
    ...
    <div class="bottom-section">
        <form action="{{route('homework.update',  ['homework' => $homework, 'subject' => $subject])}}" method="post"
            ...
            <div class="form-container row">
                ...
                @else
                    <div class="col-md-3 col-xl-2 flex gap-4">
                        <div class="col-auto">
                            <p class="input-label">Υπάρχον Αρχείο</p>
                            <a href="{{$homework->filepath}}" download>{{basename($homework->filepath)}}</a>
                            <a href="{{route('homework.file.delete' , ['homework' => $homework])}}"><i
                                    class="fa-regular fa-trash-can text-lg ml-1"></i></a>
                        </div>
                        <div class="col-auto">
